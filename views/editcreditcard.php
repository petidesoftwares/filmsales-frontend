...
<div class="payment-main-display-page">
    <div class="form-pane">
        <div class="payment-form">
            <div class="form-title"><h3>Edit Credit Card</h3></div>

            <div class="form-component">
                <label>Bank Name:</label> <input type="text" name="bank-name" class="form-element" id="edit_add_bank_name" required>
            </div>
            <div class="form-component">
                <label>Card Number:</label> <input type="number" name="card-number" class="form-element" id="edit_add_card_number" required>
            </div>
            <div class="form-component">
                <label>Card Type:</label> <input type="text" name="card-type" class="form-element" id="edit_add_card_type" required>
            </div>
            <div class="form-component">
                <label>Security Number (cvv):</label> <input type="number" name="cvv" class="form-element" id="edit_add_cvv" required>
            </div>
            <div class="form-component">
                <label>Expiry Date:</label> <input type="date" name="expiry-date" class="form-element" id="edit_add_expiry_date" required>
            </div>

            <button type="button" id="create-credit-card" class="btn" onclick="editCreditCardt()">Pay</button>
        </div>
    </div>
</div>
</body>
